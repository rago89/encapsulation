...

{
	...
	console.assert(
		test0,
		'0. `this` refers to prototype when called on prototype'
	);
	...
	console.assert(
		test1,
		'1. `this` references instance 1 when called on instance 1'
	);
	...
	console.assert(
		test2,
		'2. `this` references instance 2 when called on instance 2'
	);
